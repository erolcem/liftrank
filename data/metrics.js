...
export const THRESH = {
  ...
  // ── PERFORMANCE & CNS
  run20k:     [9.0, 11.0, 13.0, 14.5, 16.0, 18.0, 20.0],
  plank:      [60,  120,  180,  240,  300,  360,  420 ],
  vert:       [40,  50,   60,   70,   80,   90,   100 ],
...
export const MUSCLES = [
  ...
  { id: 'run20k',   label: '20k Run',      measure: 'Average speed km/h over a 20 km run or time trial',      ex: 'Speed km/h',     front: [], back: [], inner: ['I-tibia-l','I-tibia-r'],type: 'score', unit: 'km/h',  icon: '🏃', cat: 'inner' },
