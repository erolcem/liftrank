...
export const MUSCLES = [
  ...
  { id: 'restHeart', label: 'Resting Heart Rate', measure: 'Your resting heart rate in bpm — use Polar H10 or Oura ring', ex: '100-BPM', front: [], back: [], inner: ['I-hand-l','I-hand-r'], type: 'score', unit: '100-bpm', icon: '🫀', cat: 'inner' },
