...
export const THRESH = {
  ...
  restHeart:  [15,  25,  30,  35,  40,  45,  50 ],
...
export const MUSCLES = [
  ...
  { id: 'hrv',      label: 'HRV',          measure: 'Morning resting HRV in ms — use Polar H10 or Oura ring',          ex: 'CNS Recovery',   front: [], back: [], inner: ['I-hand-l','I-hand-r'], type: 'score', unit: 'ms',    icon: '❤️', cat: 'inner' },
  ...
  { id: 'restHeart', label: 'Resting Heart Rate', measure: 'Your resting heart rate in bpm — use Polar H10 or Oura ring', ex: '100-BPM', front: [], back: [], inner: ['I-heart'],              type: 'score', unit: '100-bpm', icon: '🫀', cat: 'inner' },
